...
python3.11 run_slicegpt_perplexity.py --model microsoft/phi-2 --save-dir /storage/paulclotan/SmartSliceGPT/save_work2 --sparsity 0.3 --no-wandb --device cuda:2 --hf-token hf_jucILpakjSHaCoAHxZkBwPQLGdGorpzhcqvclear --slice-layer 0 --slice-dimension 20 --add_dimension True
